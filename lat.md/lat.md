...
- [[command-collision]] — the historical `/diff-review` name clash with visual-explainer and the collision-proof `/diffweb` naming
- [[last-commit]] — last commit tracker for documentator runs
